...
<div class="card-body">
                    <form  action="{{Route('attr.save')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
                            ...
                            <input type="text" name="txtvalue" class="form-control" id="validationCustom01" placeholder="EX: X,L,M,S"  required>
                            <br>
