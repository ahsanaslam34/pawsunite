                        ...
                        <div class="row">
                                ...
                                <div class="slick-wrapper">
                                    <div class="slider-for mb-3">
                                        <div class="slick-slide-item">
                                            <img src="dashboard_assets/assets/images/products/2.jpg" class="w-100 rounded"
                                                 alt="image">
                                        </div>
                                        <div class="slick-slide-item">
                                            <img src="dashboard_assets/assets/images/products/1.jpg" class="w-100 rounded"
                                                 alt="image">
                                        </div>
                                        <div class="slick-slide-item">
                                            <img src="dashboard_assets/assets/images/products/3.jpg" class="w-100 rounded"
                                                 alt="image">
                                        </div>
                                        <div class="slick-slide-item">
                                            <img src="dashboard_assets/assets/images/products/4.jpg" class="w-100 rounded"
                                                 alt="image">
                                        </div>
                                        <div class="slick-slide-item">
                                            <img src="dashboard_assets/assets/images/products/5.jpg" class="w-100 rounded"
                                                 alt="image">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-7">
                                <div class="d-flex justify-content-between align-items-start mt-4 mt-md-0">
                                    <div>
                                        <div class="small text-muted mb-2">Category / Sub Category</div>
                                        <h2>Ad Title </h2>  Date:20/02/2022 15:10PM
                                        <p>
                                            ...
                                            <div class="row row-cols-lg-auto">
                                                <div class="col-12">
                                                    <div class="input-group">
                                                        ...
                                                        <button class="btn btn-primary sweetAlert2-example2-success me-1" type="button">Approve</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="list-group list-group-flush mb-4">
                                            ...
                                            <div class="list-group-item d-flex px-0">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="dashboard_assets/assets/images/user/man_avatar2.jpg" class="rounded-circle" alt="image">
                                                </div>
                                                <div>
